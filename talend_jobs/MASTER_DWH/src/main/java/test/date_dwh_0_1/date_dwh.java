...
/**
 * Job: date_dwh Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class date_dwh implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "date_dwh";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(date_dwh.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    final static byte[] commonByteArrayLock_TEST_date_dwh = new byte[0];
    static byte[] commonByteArray_TEST_date_dwh = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TEST_date_dwh.length) {
				if(length < 1024 && commonByteArray_TEST_date_dwh.length == 0) {
   					commonByteArray_TEST_date_dwh = new byte[1024];
				} else {
   					commonByteArray_TEST_date_dwh = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TEST_date_dwh, 0, length);
			strReturn = new String(commonByteArray_TEST_date_dwh, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_TEST_date_dwh, 0, length);
			strReturn = new String(commonByteArray_TEST_date_dwh, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TEST_date_dwh) {
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:ja1j8ARoIYS1uCwMxz7uEDZMYh2fjvqBVgBUTQrj");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
    tableName_tDBOutput_1 = "DimDates";
} else {
    tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "DimDates";
}
	int count_tDBOutput_1=0;

        String update_tDBOutput_1 = "UPDATE [" + tableName_tDBOutput_1 + "] SET [Date] = ?,[Jour_Moi_Annee] = ?,[Annee] = ?,[ID_Semestre] = ?,[Semestre] = ?,[ID_Trimestre] = ?,[Trimestre] = ?,[ID_Mois] = ?,[Mois] = ?,[Lib_Mois] = ?,[Jour] = ?,[Id_Lib_Jour] = ?,[Lib_Jour] = ?,[Semaine] = ?,[JourDeAnnee] = ?,[Jour_mois_lettre] = ? WHERE [Date_PK] = ?";
        java.sql.PreparedStatement pstmtUpdate_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(update_tDBOutput_1);
        resourceMap.put("pstmtUpdate_tDBOutput_1", pstmtUpdate_tDBOutput_1);
        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([Date_PK],[Date],[Jour_Moi_Annee],[Annee],[ID_Semestre],[Semestre],[ID_Trimestre],[Trimestre],[ID_Mois],[Mois],[Lib_Mois],[Jour],[Id_Lib_Jour],[Lib_Jour],[Semaine],[JourDeAnnee],[Jour_mois_lettre]) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
int nb_max_row_tRowGenerator_1 = 21916;
...
class tRowGenerator_1Randomizer {
	...
	for (int itRowGenerator_1=0; itRowGenerator_1<nb_max_row_tRowGenerator_1 ;itRowGenerator_1++) {
		row1.index = randtRowGenerator_1.getRandomindex();
...
Var.date = TalendDate.addDate(
    TalendDate.parseDate("yyyy-MM-dd","1990-01-01"),
    row1.index,
    "dd") ;
Var.annee = Integer.parseInt(TalendDate.formatDate("yyyy", Var.date)) ;
Var.mois = Integer.parseInt(TalendDate.formatDate("MM", Var.date));
Var.jour = Integer.parseInt(TalendDate.formatDate("dd", Var.date));
Var.semestre = Var.mois <= 6 ? 1 : 2 ;
Var.trimestre = (Var.mois - 1) / 3 + 1;// ###############################
        // ###############################
        // # Output tables
...
Var.annee >= 1990 && Var.annee <= 2050

 ) {
out1_tmp.Date_PK = Integer.parseInt(TalendDate.formatDate("yyyyMMdd", Var.date)) ;
out1_tmp.Date = Var.date ;
out1_tmp.Jour_Moi_Annee = new java.text.SimpleDateFormat("d - MMMM - yyyy", java.util.Locale.FRENCH).format(Var.date) ;
out1_tmp.Annee = Var.annee;
out1_tmp.ID_Semestre = String.valueOf(Var.annee) + " Semestre " + String.valueOf(Var.semestre) ;
out1_tmp.Semestre = "Semestre " + String.valueOf(Var.semestre) ;
out1_tmp.ID_Trimestre = String.valueOf(Var.annee) + " Trimestre " + String.valueOf(Var.trimestre) ;
out1_tmp.Trimestre = "Trimestre " + String.valueOf(Var.trimestre) ;
out1_tmp.ID_Mois = Integer.parseInt(TalendDate.formatDate("yyyyMM", Var.date)) ;
out1_tmp.Mois = Var.mois ;
out1_tmp.Lib_Mois = new java.text.SimpleDateFormat("MMMM", java.util.Locale.FRENCH).format(Var.date) ;
out1_tmp.Jour = Var.jour ;
out1_tmp.Id_Lib_Jour = Integer.parseInt(TalendDate.formatDate("u", Var.date)) ;
out1_tmp.Lib_Jour = new java.text.SimpleDateFormat("EEEE", java.util.Locale.FRENCH).format(Var.date) ;
out1_tmp.Semaine = Integer.parseInt(TalendDate.formatDate("ww", Var.date)) ;
out1_tmp.JourDeAnnee = Integer.parseInt(TalendDate.formatDate("DDD", Var.date)) ;
out1_tmp.Jour_mois_lettre = new java.text.SimpleDateFormat("EEEE - d - MMMM", java.util.Locale.FRENCH).format(Var.date) ;
out1 = out1_tmp;
...
pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.TIMESTAMP);
                    ...
                    if(out1.Jour_Moi_Annee == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, out1.Jour_Moi_Annee);
}

                    if(out1.Annee == null) {
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(3, out1.Annee);
}

                    if(out1.ID_Semestre == null) {
pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(4, out1.ID_Semestre);
}

                    if(out1.Semestre == null) {
pstmtUpdate_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(5, out1.Semestre);
}

                    if(out1.ID_Trimestre == null) {
pstmtUpdate_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(6, out1.ID_Trimestre);
}

                    if(out1.Trimestre == null) {
pstmtUpdate_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(7, out1.Trimestre);
}

                    if(out1.ID_Mois == null) {
pstmtUpdate_tDBOutput_1.setNull(8, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(8, out1.ID_Mois);
}

                    if(out1.Mois == null) {
pstmtUpdate_tDBOutput_1.setNull(9, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(9, out1.Mois);
}

                    if(out1.Lib_Mois == null) {
pstmtUpdate_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(10, out1.Lib_Mois);
}

                    if(out1.Jour == null) {
pstmtUpdate_tDBOutput_1.setNull(11, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(11, out1.Jour);
}

                    if(out1.Id_Lib_Jour == null) {
pstmtUpdate_tDBOutput_1.setNull(12, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(12, out1.Id_Lib_Jour);
}

                    if(out1.Lib_Jour == null) {
pstmtUpdate_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(13, out1.Lib_Jour);
}

                    if(out1.Semaine == null) {
pstmtUpdate_tDBOutput_1.setNull(14, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(14, out1.Semaine);
}

                    if(out1.JourDeAnnee == null) {
pstmtUpdate_tDBOutput_1.setNull(15, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(15, out1.JourDeAnnee);
}

                    if(out1.Jour_mois_lettre == null) {
pstmtUpdate_tDBOutput_1.setNull(16, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(16, out1.Jour_mois_lettre);
}


                    if(out1.Date_PK == null) {
pstmtUpdate_tDBOutput_1.setNull(17 + count_tDBOutput_1, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(17 + count_tDBOutput_1, out1.Date_PK);
}
...
} else {pstmtInsert_tDBOutput_1.setInt(1, out1.Date_PK);
}
...
} else {pstmtInsert_tDBOutput_1.setString(3, out1.Jour_Moi_Annee);
}

                        if(out1.Annee == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(4, out1.Annee);
}

                        if(out1.ID_Semestre == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(5, out1.ID_Semestre);
}

                        if(out1.Semestre == null) {
pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(6, out1.Semestre);
}

                        if(out1.ID_Trimestre == null) {
pstmtInsert_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(7, out1.ID_Trimestre);
}

                        if(out1.Trimestre == null) {
pstmtInsert_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(8, out1.Trimestre);
}

                        if(out1.ID_Mois == null) {
pstmtInsert_tDBOutput_1.setNull(9, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(9, out1.ID_Mois);
}

                        if(out1.Mois == null) {
pstmtInsert_tDBOutput_1.setNull(10, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(10, out1.Mois);
}

                        if(out1.Lib_Mois == null) {
pstmtInsert_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(11, out1.Lib_Mois);
}

                        if(out1.Jour == null) {
pstmtInsert_tDBOutput_1.setNull(12, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(12, out1.Jour);
}

                        if(out1.Id_Lib_Jour == null) {
pstmtInsert_tDBOutput_1.setNull(13, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(13, out1.Id_Lib_Jour);
}

                        if(out1.Lib_Jour == null) {
pstmtInsert_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(14, out1.Lib_Jour);
}

                        if(out1.Semaine == null) {
pstmtInsert_tDBOutput_1.setNull(15, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(15, out1.Semaine);
}

                        if(out1.JourDeAnnee == null) {
pstmtInsert_tDBOutput_1.setNull(16, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(16, out1.JourDeAnnee);
}

                        if(out1.Jour_mois_lettre == null) {
pstmtInsert_tDBOutput_1.setNull(17, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(17, out1.Jour_mois_lettre);
}
 ...
 */
    ...
    public static void main(String[] args){
        final date_dwh date_dwhClass = new date_dwh();

        int exitCode = date_dwhClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = date_dwh.class.getClassLoader().getResourceAsStream("test/date_dwh_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = date_dwh.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : date_dwh");
        }
...
/************************************************************************************************
 *     67745 characters generated by Talend Open Studio for Data Integration 
 *     on the 29 mars 2026, 15:08:26 WAT
 ************************************************************************************************/