...
package test.localisation_dwh_0_1;
...
/**
 * Job: Localisation_DWH Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Localisation_DWH implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Localisation_DWH";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Localisation_DWH.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Localisation_DWH.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
    final static byte[] commonByteArrayLock_TEST_Localisation_DWH = new byte[0];
    static byte[] commonByteArray_TEST_Localisation_DWH = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TEST_Localisation_DWH.length) {
				if(length < 1024 && commonByteArray_TEST_Localisation_DWH.length == 0) {
   					commonByteArray_TEST_Localisation_DWH = new byte[1024];
				} else {
   					commonByteArray_TEST_Localisation_DWH = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TEST_Localisation_DWH, 0, length);
			strReturn = new String(commonByteArray_TEST_Localisation_DWH, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_TEST_Localisation_DWH, 0, length);
			strReturn = new String(commonByteArray_TEST_Localisation_DWH, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TEST_Localisation_DWH) {
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:rgzYUItX99hObaj5gYxrI+Ltul/YazC/va9wZvXJ");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	...
	int count_tDBOutput_1=0;
        ...
        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([city],[country]) VALUES (?,?)";
 ...
 */
	...
	currentComponent="tUnite_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"row3","row2","row1");
					}
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
		    ...
		    java.sql.Connection conn_tDBInput_1 = null;
				...
				String dbUser_tDBInput_1 = "bi";
				
				 
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:WVikrFymSkMN/mX71SxuCyFhnR5EqcOY/9z/UGEf");
				
				String dbPwd_tDBInput_1 = decryptedPassword_tDBInput_1;
				
		    String port_tDBInput_1 = "1433";
		    String dbname_tDBInput_1 = "event_DWH" ;		    
		    String url_tDBInput_1 = "jdbc:sqlserver://" + "localhost" ;
		    if (!"".equals(port_tDBInput_1)) {
		    	url_tDBInput_1 += ":" + "1433";
		    }
		    if (!"".equals(dbname_tDBInput_1)) {		    
		    	url_tDBInput_1 += ";databaseName=" + "event_DWH"; 
		    }
		    ...
		    String dbquery_tDBInput_1 = "select city , country  from Dim_Concurrence ;";
...
if(row4.city == null){
	...
	finder_tUniqRow_1.city = row4.city.toLowerCase();
}
if(row4.country == null){
	finder_tUniqRow_1.country = null;
}else{
	finder_tUniqRow_1.country = row4.country.toLowerCase();
}	
...
if(row4.city == null){
	...
	new_tUniqRow_1.city = row4.city.toLowerCase();
}
if(row4.country == null){
	new_tUniqRow_1.country = null;
}else{
	new_tUniqRow_1.country = row4.country.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row5 == null){ 
	
	row5 = new row5Struct();
}row5.city = row4.city;			row5.country = row4.country;					
...
} else {pstmt_tDBOutput_1.setString(1, row5.city);
}

                    if(row5.country == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, row5.country);
}
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:REvxmvtPESpnH/mKLvMaoSDx6N8TXqsxkeCA5/7p");
		    ...
		    String dbquery_tDBInput_2 = "SELECT city ,\n       'Tunisie' AS country\nFROM Dim_Venue ;";
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.country = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row2.country = tmpContent_tDBInput_2;
                }
            } else {
                row2.country = null;
            }
 ...
 */
	...
	final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:XbfuH4MpzqniLTgXEYcyLjgt294GbaZ3BTTaR+1+");
		    ...
		    String dbquery_tDBInput_3 = "SELECT city  ,\n       'Tunisie' AS country\nFROM Dim_Provider ;";
            ...
            if(tmpContent_tDBInput_3 != null) {
            	if (talendToDBList_tDBInput_3 .contains(rsmd_tDBInput_3.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row3.country = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
            	} else {
                	row3.country = tmpContent_tDBInput_3;
                }
            } else {
                row3.country = null;
            }
...
globalMap.put("tUnite_1_NB_LINE", nb_line_tUnite_1);
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"row3","row2","row1");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final Localisation_DWH Localisation_DWHClass = new Localisation_DWH();

        int exitCode = Localisation_DWHClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Localisation_DWH.class.getClassLoader().getResourceAsStream("test/localisation_dwh_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Localisation_DWH.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Localisation_DWH");
        }
...
/************************************************************************************************
 *     100951 characters generated by Talend Open Studio for Data Integration 
