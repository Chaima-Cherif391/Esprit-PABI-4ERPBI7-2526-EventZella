...
/**
 * Job: MASTER_DWH Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class MASTER_DWH implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "MASTER_DWH";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(MASTER_DWH.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		test.date_dwh_0_1.date_dwh childJob_tRunJob_1 = new test.date_dwh_0_1.date_dwh();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		test.category_dwh_0_1.category_dwh childJob_tRunJob_2 = new test.category_dwh_0_1.category_dwh();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		test.subcategory_dwh_0_1.Subcategory_DWH childJob_tRunJob_3 = new test.subcategory_dwh_0_1.Subcategory_DWH();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		test.provider_dwh_0_1.provider_DWH childJob_tRunJob_4 = new test.provider_dwh_0_1.provider_DWH();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		test.localisation_dwh_0_1.Localisation_DWH childJob_tRunJob_5 = new test.localisation_dwh_0_1.Localisation_DWH();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		test.weather_dwh_0_1.weather_dwh childJob_tRunJob_6 = new test.weather_dwh_0_1.weather_dwh();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_7 = null;
		...
		test.venues_dwh_0_1.venues_DWH childJob_tRunJob_7 = new test.venues_dwh_0_1.venues_DWH();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_8 = null;
		...
		test.evaluation_dwh_0_1.evaluation_DWH childJob_tRunJob_8 = new test.evaluation_dwh_0_1.evaluation_DWH();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_9 = null;
		...
		test.complain_dwh_0_1.complain_dwh childJob_tRunJob_9 = new test.complain_dwh_0_1.complain_dwh();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_10 = null;
		...
		test.beneficiary_0_1.beneficiary childJob_tRunJob_10 = new test.beneficiary_0_1.beneficiary();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_11 = null;
		...
		test.event_dwh_0_1.event_dwh childJob_tRunJob_11 = new test.event_dwh_0_1.event_dwh();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_12 = null;
		...
		test.copy_of_service_dwh_0_1.Copy_of_service_dwh childJob_tRunJob_12 = new test.copy_of_service_dwh_0_1.Copy_of_service_dwh();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_13 = null;
		...
		test.trends_dwh_0_1.Trends_DWH childJob_tRunJob_13 = new test.trends_dwh_0_1.Trends_DWH();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_14 = null;
		...
		test.scd_concurrence_dwh_0_1.SCD_Concurrence_DWH childJob_tRunJob_14 = new test.scd_concurrence_dwh_0_1.SCD_Concurrence_DWH();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_15 = null;
		...
		test.scd_ententainer_dwh_0_1.SCD_Ententainer_DWH childJob_tRunJob_15 = new test.scd_ententainer_dwh_0_1.SCD_Ententainer_DWH();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_16 = null;
		...
		test.fact2_0_1.Fact2 childJob_tRunJob_16 = new test.fact2_0_1.Fact2();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final MASTER_DWH MASTER_DWHClass = new MASTER_DWH();

        int exitCode = MASTER_DWHClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = MASTER_DWH.class.getClassLoader().getResourceAsStream("test/master_dwh_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = MASTER_DWH.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : MASTER_DWH");
        }
...
/************************************************************************************************
 *     146717 characters generated by Talend Open Studio for Data Integration 
