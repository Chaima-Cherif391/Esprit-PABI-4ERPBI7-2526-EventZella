...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:gMtwPbAzrQ6H+Y1eBsf5CQKrVqwwXCIcNO3V254i");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	...
	int count_tDBOutput_1=0;
        ...
        String update_tDBOutput_1 = "UPDATE [" + tableName_tDBOutput_1 + "] SET [ville] = ?,[date] = ?,[saison] = ?,[condition_meteo] = ?,[temp_max] = ?,[temp_min] = ?,[precipitation] = ?,[wind_speed_max] = ?,[humidity_mean] = ?,[weather_code] = ? WHERE [id_weather] = ?";
        java.sql.PreparedStatement pstmtUpdate_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(update_tDBOutput_1);
        resourceMap.put("pstmtUpdate_tDBOutput_1", pstmtUpdate_tDBOutput_1);
        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([id_weather],[ville],[date],[saison],[condition_meteo],[temp_max],[temp_min],[precipitation],[wind_speed_max],[humidity_mean],[weather_code]) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:SNknCpFejAfR0H3CyS2R99W76xZoD2Pn8Ui6bq1Dww==");
...
} else {pstmtUpdate_tDBOutput_1.setString(1, out.ville);
}
...
} else {pstmtInsert_tDBOutput_1.setInt(1, out.id_weather);
}

                        if(out.ville == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(2, out.ville);
}

                        if(out.date != null) {
pstmtInsert_tDBOutput_1.setTimestamp(3, new java.sql.Timestamp(out.date.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_1.setString(4, out.saison);
}

                        if(out.condition_meteo == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(5, out.condition_meteo);
}

                        if(out.temp_max == null) {
pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.FLOAT);
} else {pstmtInsert_tDBOutput_1.setFloat(6, out.temp_max);
}

                        if(out.temp_min == null) {
pstmtInsert_tDBOutput_1.setNull(7, java.sql.Types.FLOAT);
} else {pstmtInsert_tDBOutput_1.setFloat(7, out.temp_min);
}

                        if(out.precipitation == null) {
pstmtInsert_tDBOutput_1.setNull(8, java.sql.Types.FLOAT);
} else {pstmtInsert_tDBOutput_1.setFloat(8, out.precipitation);
}

                        if(out.wind_speed_max == null) {
pstmtInsert_tDBOutput_1.setNull(9, java.sql.Types.FLOAT);
} else {pstmtInsert_tDBOutput_1.setFloat(9, out.wind_speed_max);
}

                        if(out.humidity_mean == null) {
pstmtInsert_tDBOutput_1.setNull(10, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(10, out.humidity_mean);
}

                        if(out.weather_code == null) {
pstmtInsert_tDBOutput_1.setNull(11, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(11, out.weather_code);
}
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = weather_dwh.class.getClassLoader().getResourceAsStream("test/weather_dwh_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = weather_dwh.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
/************************************************************************************************
 *     80682 characters generated by Talend Open Studio for Data Integration 
